...
A quiz/trivia game with different modes and categories that you can select, as well as wildcards to help you. The questions are generated by artificial intelligence using the [Cohere API](https://dashboard.cohere.ai/welcome/register).
  ...
  ·
  <a href="https://github.com/devbluecomet/quiz-game/issues">Report Bug</a>
  ·
  <a href="https://github.com/devbluecomet/quiz-game/issues">Request Feature</a>
</div>
...
```sh
git clone https://github.com/devbluecomet/quiz-game
```
...
Distributed under the MIT License. See [`LICENSE.txt`](https://github.com/devbluecomet/quiz-game/blob/main/LICENCE) for more information.
